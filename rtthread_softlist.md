...
| [3gpp_amrnb](https://github.com/myshowtogo/3gpp_amrnb) |myshow|Apache|3gpp amrnb 编解码库|
| [LittlevGL2RTT](https://github.com/liu2guang/LittlevGL2RTT) |liu2guang|MIT|LittlevGL 图形库 (LVGL 7.x, 老版本)|
...
| [APID](https://github.com/Dyyt587/all_pid) |https://github.com/Dyyt587|Apache-2.0|一个强大而全面的pid库,绝对惊艳。|
| [kissfft](https://github.com/mborgerding/kissfft) |mborgerding|BSD-3-Clause|简单、快速的FFT(快速傅里叶变换)算法软件包|
| [CMSIS-DSP](https://github.com/RT-Thread-packages/CMSIS-DSP) |ARM-software|Apache-2.0|CMSIS-DSP嵌入式计算库（Cortex-M和Cortex-A）|
| [qpid](https://github.com/qiyongzhong0/rt-thread-qpid) |qiyongzhong0| LGPL-2.1|一款快捷易用的PID自动控制算法包，支持增量式和位置式算法。|
...
| [r-tinymaix](https://github.com/RiceChen0/r-tinymaix) |RiceChen|Apache-2.0|r-tinymaix TinyMaix是面向单片机的超轻量级的神经网络推理库，即TinyML推理库，可以让你在任意单片机上运行轻量级深度学习模型|
| [ulapack](https://github.com/wuhanstudio/ulapack) |wuhanstudio|MIT|嵌入式线性代数库|
| [naxos](https://github.com/wuhanstudio/naxos) |wuhanstudio|LGPL-3.0|C++ Constraint Programming Library|
...
| [ncnn](https://github.com/yc66542260/ncnn-rtthread) |yechang|BSD-3-Clause|ncnn静态库|
...
| [llmchat](https://github.com/Rbb666/llm_chat) |Rbb666|MIT|在 RT-Thread 上进行 LLM 大语言模型对话|
...
| [RVBacktrace](https://github.com/Yaochenger/RvBacktrace) |Yaochenger|Apache-2.0|RISC-V 极简栈回溯组件|
...
| [zdebug](https://github.com/beisongcrt/zdebug.git) |beisongcrt|Apache-2.0|方便的调试工具，随时控制打印 log，查看、设置变量数据，执行函数。|
| [mem_sandbox](https://github.com/mysterywolf/mem_sandbox) |Meco Man|MIT|RT-Thread 内存隔离沙箱|
...
| [rtt_auto_exe_cmd](https://github.com/supperthomas/RTT_AUTO_EXE_CMD.git) |supperthomas|Apache-2.0|该软件包用来自动执行finsh的命令，主要给CI机器人使用|
...
| [RT_Trace](https://github.com/Ruboom/RT_Trace) |liboran|Commercial License|使用 J-Link 实现事件监控|
...
| [hpatchlite-wrapper](https://github.com/sulfurandcu/hpatchlite-wrapper) |sulfurandcu|MIT|一个让HPatchLite差分还原算法库更好用的封装|
...
## system
 ...
 | 包名 | 作者  | license   | 备注      |
| ------------------------------------------------------------ | ------------------- | -------------------- | ------------------------------------------------------------ |
| [littlefs](https://github.com/RT-Thread-packages/littlefs) |geniusgogo|BSD-3-Clause|为微控制器设计的一个小型的且掉电安全的文件系统|
| [thread_pool](https://github.com/armink-rtt-pkgs/thread_pool) |armink|MIT|基于 RT-Thread 的线程池实现|
| [mlibc](https://github.com/plctlab/mlibc) |plctlab|MIT|mbedded libc, especially for RISC-V|
...
| [rt_vsnprintf_full](https://github.com/mysterywolf/rt_vsnprintf_full) |Meco Man|Apache-2.0|rt_vsnprintf全功能版本|
...
| [uC_Modbus](https://github.com/mysterywolf/uC-Modbus-for-RT-Thread) |Meco Man|Apache-2.0|uC/Modbus for RT-Thread|
| [uC_Common](https://github.com/mysterywolf/uC-Common-for-RT-Thread) |Meco Man|Apache-2.0|uC/Common for RT-Thread|
| [uC_CRC](https://github.com/mysterywolf/uC-CRC-for-RT-Thread) |Meco Man|Apache-2.0|uC/CRC for RT-Thread|
| [uC_CLK](https://github.com/mysterywolf/uC-Clk-for-RT-Thread) |Meco Man|Apache-2.0|uC/Clk for RT-Thread|
| [EV](https://github.com/sogwms/EV) |sogwms|Apache-2.0|高效开发 vehicles(包括无人机) 的框架|
| [sfdb](https://github.com/WKJay/sfdb) |WKJay|Apache-2.0|简单文件数据库|
| [rmp](https://github.com/RiceChen0/rmp) |RiceChen|Apache-2.0|rmp: 高效且安全的内存池|
| [qboot](https://github.com/qiyongzhong0/rt-thread-qboot) |qiyongzhong0| LGPL-2.1|qboot ：一个用于快速制作bootloader的组件|
| [UartFramework](https://github.com/slyant/uart-framework) |slyant|Apache-2.0|基于RT-Thread的串口通讯框架软件包。|
...
| [filex](https://github.com/RT-Thread-packages/filex) |67887002|Unknown|fiex 在rtthread 的移植。|
| [openamp](https://github.com/bigmagic123/openamp.git) |RealThread|LGPL-2.1|RT-Thread OpenAMP软件包|
| [perf_counter](https://github.com/RT-Thread-packages/perf_counter) |GorgonMeducer|Apache-2.0|Cortex-M systick 的专用计数器|
...
| [CMSIS-Core](https://github.com/RT-Thread-packages/CMSIS-Core) |RT-Thread-packages|Apache-2.0|适用于 Cortex-A/M 处理器内核和外设的标准化 API。|
| [CMSIS_5_AUX](https://github.com/RT-Thread-packages/CMSIS_5_AUX) |RT-Thread-packages|Apache-2.0|CMSIS_5软件包的辅助构建软件包（该软件包不需要用户选择）|
| [CMSIS-NN](https://github.com/RT-Thread-packages/CMSIS-NN) |RT-Thread-packages|Apache-2.0|适用于 Arm Cortex-M CPU 的高效神经网络内核|
| [CMSIS_RTOS1](https://github.com/RT-Thread-packages/CMSIS_RTOS1) |RT-Thread-packages|Apache-2.0|RT-Thread的CMSIS-RTOS1标准兼容层|
| [flash_blob](https://github.com/Aladdin-Wang/flash_blob.git) |kk|Apache-2.0|用于快速生成flash驱动文件的工具和flash抽象层。|
| [TFDB](https://github.com/smartmx/TFDB) |smartmx|MIT|通用精简稳定的单片机flash存储数据方案|
| [LiteOS-SDK](https://github.com/RT-Thread-packages/LiteOS-SDK) |RT-Thread-packages|Apache-2.0|LiteOS SDK|
| [FlashDB](https://github.com/armink/FlashDB) |armink|Apache-2.0|一款支持 KV 数据和时序数据的轻量级数据库|
| [heartbeat](https://github.com/Maihuanyi/heartbeat) |Chasel| LGPL-2.1|一个适用于rt-thread的heartbeat的软件包。|
| [minIni](https://github.com/hichard/minIni) |hichard|Apache-2.0|minIni 在 RT-Thread 上移植的软件包|
| [aUnity](https://github.com/Dyyt587/aUnity_rtt) |Dyyt587|Apache-2.0|all 系列的基础功能支持包。|
...
| [rtp](https://github.com/RiceChen0/rtp) |RiceChen|Apache-2.0|rtp 跨平台线程|
...
| [tz-database](https://github.com/RT-Thread-packages/tz) |eggert|BSD-3-Clause|时区和夏令时数据库|
| [TinyUSB](https://github.com/RT-Thread-packages/tinyusb) |tfx2001|MIT|用于嵌入式系统的开源跨平台USB协议栈|
| [r-rhealstone](https://github.com/RiceChen0/r-rhealstone) |RiceChen|Apache-2.0|r-rhealstone: 一个跨平台实时系统基准测试框架|
...
| [rpmsg-lite](https://github.com/flyingcys/rpmsg-lite) |flyingcys|Apache-2.0|RT-Thread rpmsg-lite 软件包|
| [reb](https://github.com/RiceChen0/reb) |RiceChen|Apache-2.0|reb: 基于发布-订阅的事件代理组件|
...
| [CherryUSB](https://github.com/cherry-embedded/CherryUSB) |sakumisu|Apache-2.0|小而美、可移植性高的 USB 主从协议栈。|
...
| [levelx](https://github.com/RT-Thread-packages/levelx.git) |Dyyt587|MIT|Threadx生态组件，磨损均衡组件 |
| [TaskMsgBus](https://github.com/slyant/TaskMsgBus.git) |slyant|Apache-2.0|基于RT-Thread线程间同步和通讯的消息总线管理通用软件包|
| [kmulti_rtimer](https://github.com/kylepengchn/kmulti_rtimer.git) |kylepengchn|Apache-2.0|基于RT-Thread线程间同步和通讯的消息总线管理通用软件包|
...
| [uat](https://github.com/qiyongzhong0/rt-thread-uat) |qiyongzhong0| LGPL-2.1|微型AT设备驱动接口组件。|
| [ft6236](https://github.com/RT-Thread-packages/ft6236) |liuduanfei|Apache-2.0|这是 FT6236 触摸芯片的驱动包。|
...
| [gt911](https://github.com/RiceChen0/gt911) |RiceChen|Apache-2.0|gt911 驱动。|
| [cst812t](https://github.com/StackYuan/cst812t) |StackYuan|Apache-2.0|cst812t 触摸芯片驱动程序。|
...
| [System_Run_LED](https://github.com/WennianYan/System_Run_LED) |WennianYan|Apache-2.0|系统运行指示灯：超级简单实用的系统运行指示灯控制线程。|
...
| [mm32](https://github.com/Maihuanyi/mm32) |Maihuanyi|BSD-3-Clause|mm32官方独立外设驱动库。|
...
| [x9555](https://github.com/WennianYan/x9555) |WennianYan|Apache-2.0|IO 扩展器：具有中断、弱上拉和配置寄存器的 16 位 1.65V 至 5.5V I2C/SMBus I/O 扩展器。|
...
| [RgPower](https://github.com/1300650671/RgPower) |liuxx|Apache-2.1|电源电压获取模块|
...
| [bt_mx02](https://github.com/qiyongzhong0/rt-thread-bt_mx02) |qiyongzhong0| LGPL-2.1|蓝牙芯片MX-02的设备驱动|
...
| [Servo_sg90](https://github.com/CXSforHPU/Servo_sg90) |CXSforHPU|MIT|使用一款软件包进行控制舵机|
| [nxp-mcx-cmsis](https://github.com/RT-Thread-packages/nxp-mcx-cmsis) |RT-Thread-packages|Apache-2.0|NXP MCX CMSIS 驱动包|
| [nxp-mcx-series](https://github.com/RT-Thread-packages/nxp-mcx-series) |RT-Thread-packages|Apache-2.0|NXP MCX SERIES 驱动包|
| [nxp-imxrt-sdk](https://github.com/RT-Thread-packages/nxp-imxrt-sdk) |RT-Thread-packages|Apache-2.0|NXP IMXRT 驱动包|
| [nxp-lpc55s-series](https://github.com/RT-Thread-packages/nxp-lpc55s-series) |RT-Thread-packages|Apache-2.0|NXP LPC 驱动包|
| [nxp-imx6ul-sdk](https://github.com/RT-Thread-packages/nxp-imx6ul-sdk) |RT-Thread-packages|Apache-2.0|NXP IMX6UL 驱动包|
| [nxp-lpc-series](https://github.com/RT-Thread-packages/nxp-lpc-series) |RT-Thread-packages|Apache-2.0|NXP LPC 驱动包|
| [nxp-imx6sx-sdk](https://github.com/RT-Thread-packages/nxp-imx6sx-sdk) |RT-Thread-packages|Apache-2.0|NXP IMX6SX 驱动包|
| [ch32v307_sdk](https://github.com/openwch/ch32v307) |openwch|Apache-2.0|CH32V307 SDK for rt-thread|
| [ch32v20x_sdk](https://github.com/openwch/ch32v20x) |openwch|Apache-2.0|CH32V20x SDK for rt-thread|
...
| [Infineon_csdidac](https://github.com/LZerro/Infineon_csdidac) |LZerro|Unknown|英飞凌HAL库软件包。|
| [Infineon_usbdev](https://github.com/LZerro/Infineon_usbdev) |LZerro|Unknown|英飞凌HAL库软件包。|
| [Infineon_mtb-hal-cat1](https://github.com/LZerro/Infineon_mtb-hal-cat1) |LZerro|Unknown|英飞凌HAL库软件包。|
| [Infineon_capsense](https://github.com/LZerro/Infineon_capsense) |LZerro|Unknown|英飞凌HAL库软件包。|
| [Infineon_mtb-pdl-cat1](https://github.com/LZerro/Infineon_mtb-pdl-cat1) |LZerro|Unknown|英飞凌HAL软件包。|
| [Infineon_cat1cm0p](https://github.com/LZerro/Infineon_cat1cm0p) |LZerro|Unknown|英飞凌HAL软件包。|
| [Infineon_retarget-io](https://github.com/LZerro/Infineon_retarget-io) |LZerro|Unknown|英飞凌HAL软件包。|
| [Infineon_serial-flash](https://github.com/LZerro/Infineon_serial-flash) |LZerro|Unknown|英飞凌HAL库软件包。|
| [Infineon_cmsis](https://github.com/LZerro/Infineon_cmsis) |LZerro|Unknown|英飞凌HAL软件包。|
| [Infineon_core-lib](https://github.com/LZerro/Infineon_core-lib) |LZerro|Unknown|英飞凌HAL软件包。|
...
| [at32f415_cmsis_driver](https://github.com/sheltonyu/AT32F415_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f402_405_hal_driver](https://github.com/sheltonyu/AT32F402_405_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32f403a_407_cmsis_driver](https://github.com/sheltonyu/AT32F403A_407_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f421_hal_driver](https://github.com/sheltonyu/AT32F421_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32f403a_407_hal_driver](https://github.com/sheltonyu/AT32F403A_407_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32m412_416_hal_driver](https://github.com/sheltonyu/AT32M412_416_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 M4 HAL 驱动包|
| [at32f413_cmsis_driver](https://github.com/sheltonyu/AT32F413_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f423_hal_driver](https://github.com/sheltonyu/AT32F423_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32a423_hal_driver](https://github.com/sheltonyu/AT32A423_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 A4 HAL 驱动包|
| [at32f413_hal_driver](https://github.com/sheltonyu/AT32F413_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32a403a_hal_driver](https://github.com/sheltonyu/AT32A403A_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 A4 HAL 驱动包|
| [at32f421_cmsis_driver](https://github.com/sheltonyu/AT32F421_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f425_hal_driver](https://github.com/sheltonyu/AT32F425_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32f435_437_cmsis_driver](https://github.com/sheltonyu/AT32F435_437_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32a423_cmsis_driver](https://github.com/sheltonyu/AT32A423_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 A4 CMSIS 驱动包|
| [at32f423_cmsis_driver](https://github.com/sheltonyu/AT32F423_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f415_hal_driver](https://github.com/sheltonyu/AT32F415_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32a403a_cmsis_driver](https://github.com/sheltonyu/AT32A403A_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 A4 CMSIS 驱动包|
| [at32f45x_hal_driver](https://github.com/sheltonyu/AT32F45x_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32f402_405_cmsis_driver](https://github.com/sheltonyu/AT32F402_405_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32f45x_cmsis_driver](https://github.com/sheltonyu/AT32F45x_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [at32m412_416_cmsis_driver](https://github.com/sheltonyu/AT32M412_416_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 M4 CMSIS 驱动包|
| [at32f435_437_hal_driver](https://github.com/sheltonyu/AT32F435_437_HAL_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 HAL 驱动包|
| [at32f425_cmsis_driver](https://github.com/sheltonyu/AT32F425_CMSIS_Driver) |sheltonyu|BSD-3-Clause|AT32 F4 CMSIS 驱动包|
| [stm32h5_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-h5) |RT-Thread-packages|Apache-2.0|STM32 H5 CMSIS 驱动包|
| [stm32f4_hal_driver](https://github.com/RT-Thread-packages/stm32f4_hal_driver) |RT-Thread-packages|BSD-3-Clause|STM32 F4 HAL 驱动包|
| [stm32f0_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-f0) |RT-Thread-packages|Apache-2.0|STM32 F0 CMSIS 驱动包|
| [stm32h7_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-h7) |RT-Thread-packages|Apache-2.0|STM32 H7 CMSIS 驱动包|
| [stm32h7_hal_driver](https://github.com/RT-Thread-packages/stm32h7xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 H7 HAL 驱动包|
| [stm32f3_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-f3) |RT-Thread-packages|Apache-2.0|STM32 F3 CMSIS 驱动包|
| [stm32f3_hal_driver](https://github.com/RT-Thread-packages/stm32f3xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 F3 HAL 驱动包|
| [stm32h7rs_hal_driver](https://github.com/RT-Thread-packages/stm32h7rsxx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 H7RS HAL 驱动包|
| [stm32l5_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-l5) |RT-Thread-packages|Apache-2.0|STM32 L5 CMSIS 驱动包|
| [stm32_sdio](https://github.com/RT-Thread-packages/stm32_sdio) |RealThread|LGPL-2.1|STM32 平台 SDIO 控制器驱动包|
| [stm32f7_hal_driver](https://github.com/RT-Thread-packages/stm32f7xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 F7 HAL 驱动包|
| [stm32wb55_sdk](https://github.com/xupenghu/stm32wb55_sdk.git) |xph|Apache-2.0|stm32wb55_sdk 软件包|
| [stm32wb_hal_driver](https://github.com/RT-Thread-packages/stm32wbxx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 WB HAL 驱动包|
| [stm32g4_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-g4) |RT-Thread-packages|Apache-2.0|STM32 G4 CMSIS 驱动包|
| [stm32f4_cmsis_driver](https://github.com/RT-Thread-packages/stm32f4_cmsis_driver) |RT-Thread-packages|Apache-2.0|STM32 F4 CMSIS 驱动包|
| [stm32f2_hal_driver](https://github.com/RT-Thread-packages/stm32f2xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 F2 HAL 驱动包|
| [stm32f0_hal_driver](https://github.com/RT-Thread-packages/stm32f0xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 F0 HAL 驱动包|
| [stm32wl_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-wl) |RT-Thread-packages|Apache-2.0|STM32 WL CMSIS 驱动包|
| [stm32f2_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-f2) |RT-Thread-packages|Apache-2.0|STM32 F2 CMSIS 驱动包|
| [stm32h7rs_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-h7rs) |RT-Thread-packages|Apache-2.0|STM32 H7RS CMSIS 驱动包|
| [stm32mp1_m4_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-mp1xxx-m4) |RT-Thread-packages|Apache-2.0|STM32 MP1_M4 CMSIS 驱动包|
| [stm32u5_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-u5) |RT-Thread-packages|Apache-2.0|STM32 U5 CMSIS 驱动包|
| [stm32g0_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-g0) |RT-Thread-packages|Apache-2.0|STM32 G0 CMSIS 驱动包|
| [stm32f1_hal_driver](https://github.com/RT-Thread-packages/stm32f1xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 F1 HAL 驱动包|
| [stm32wl_hal_driver](https://github.com/RT-Thread-packages/stm32wlxx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 WL HAL 驱动包|
| [stm32u5_hal_driver](https://github.com/RT-Thread-packages/stm32u5xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 U5 HAL 驱动包|
| [stm32h5_hal_driver](https://github.com/RT-Thread-packages/stm32h5xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 H5 HAL 驱动包|
| [stm32f1_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-f1) |RT-Thread-packages|Apache-2.0|STM32 F1 CMSIS 驱动包|
| [stm32l0_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-l0) |RT-Thread-packages|Apache-2.0|STM32 L0 CMSIS 驱动包|
| [stm32f7_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-f7) |RT-Thread-packages|Apache-2.0|STM32 F7 CMSIS 驱动包|
| [stm32l4_hal_driver](https://github.com/RT-Thread-packages/stm32l4_hal_driver) |RT-Thread-packages|BSD-3-Clause|STM32 L4 HAL 驱动包|
| [stm32g0_hal_driver](https://github.com/RT-Thread-packages/stm32g0xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 G0 HAL 驱动包|
| [stm32l0_hal_driver](https://github.com/RT-Thread-packages/stm32l0xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 L0 HAL 驱动包|
| [stm32l4_cmsis_driver](https://github.com/RT-Thread-packages/stm32l4_cmsis_driver) |RT-Thread-packages|Apache-2.0|STM32 L4 CMSIS 驱动包|
| [stm32mp1_m4_hal_driver](https://github.com/RT-Thread-packages/stm32mp1xx-m4-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 MP1_M4 HAL 驱动包|
| [stm32wb_cmsis_driver](https://github.com/RT-Thread-packages/cmsis-device-wb) |RT-Thread-packages|Apache-2.0|STM32 WB CMSIS 驱动包|
| [stm32g4_hal_driver](https://github.com/RT-Thread-packages/stm32g4xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 G4 HAL 驱动包|
| [stm32l5_hal_driver](https://github.com/RT-Thread-packages/stm32l5xx-hal-driver) |RT-Thread-packages|BSD-3-Clause|STM32 L5 HAL 驱动包|
...
| [hc32f4a8_ddl](https://github.com/levizh/hc32f4a8_ddl_rtt) |levizh|BSD-3-Clause|该软件包用于存放HC32F4A8的DDL库文件|
| [hc32f334_ddl](https://github.com/levizh/hc32f334_ddl_rtt) |levizh|BSD-3-Clause|该软件包用于存放HC32F334的DDL库文件|
| [agile_console](https://github.com/loogg/agile_console) |loogg|LGPL-2.1|简单易用的调试设备中间件。|
| [st7789](https://github.com/Vandoul/ST7789.git) |Vandoul|Apache-2.0|TFT-LCD ST7789 SPI 图形驱动|
...
| [vs1003](https://github.com/beisongcrt/vs1003.git) |beisongcrt|GPL-2.0|vs1003 驱动。|
| [agile_led](https://github.com/loogg/agile_led) |Longwei Ma|LGPL-2.1|一个灵活的led软件包。|
| [bt_mx01](https://github.com/qiyongzhong0/rt-thread-bt_mx01) |qiyongzhong0| LGPL-2.1|蓝牙芯片MX-01的设备驱动|
...
| [ili9341](https://github.com/Rbb666/ILI9341.git) |Rbb666|Apache-2.0|TFT-LCD ILI9341 SPI 屏幕驱动的软件包|
| [sean_ws2812b](https://github.com/godmial/sean_ws2812b.git) |godmial|Apache-2.0|基于SPI接口的WS2812B灯带驱动软件包,适用于RT-Thread 4.1.0系统。|
...
| [spi-tools](https://github.com/vandoul/rt-spi-tools) |vandoul|MIT|SPI 调试时可以使用的小工具，可以初始化、配置spi总线设备，读写spi总线设备|
...
| [sths34pf80](https://github.com/zyk6271/STHS34PF80) |rick|Apache-2.0|STHS34PF80 红外传感器的驱动包|
| [isl29035](https://github.com/ShermanShao/isl29035) |Sherman|RENESAS SOFTWARE LICENSE TERMS|Renesas 环境光线传感器 isl29035 的驱动库|
| [max31855](https://github.com/wangwang105/rtt-max31855.git) |wangwang105|MIT|数字温度传感器 max31855 的软件包|
...
| [as7341](https://github.com/RiceChen0/as7341) |RiceChen|Apache-2.0|AS7341可见光传感器，可测量8个波长的可见光。|
| [ds18b20](https://github.com/RT-Thread-packages/ds18b20) |WillianChan|Apache-2.0|数字温度传感器 ds18b20 的软件包|
...
| [p3t1755](https://github.com/CYFS3/p3t1755) |CYFS|Apache-2.0|温度到数字转换器 p3t1755 的驱动库|
...
| [mlx90382](https://github.com/lgnq/mlx90382) |lgnq|Apache-2.0|MLX90382 是来自迈来芯公司的一颗高速磁编码器|
| [qmp6989](https://github.com/kylepengchn/qmp6989.git) |kylepengchn|Apache-2.0|MLX90382 是来自迈来芯公司的一颗高速磁编码器|
...
| [sht4x](https://github.com/flyingcys/sht4x) |flyingcys|Apache-2.0|数字湿度和温度传感器 sht4x 驱动软件包|
| [mlx90394](https://github.com/lgnq/mlx90394) |lgnq|Apache-2.0|MLX90394 是来自迈来芯公司的一颗低功耗的3D磁位置传感器(磁力计)|
| [qmi8658](https://github.com/hydevcode/qmi8658.git) |hydevcode|Apache-2.0|基于qmi8658的三轴加速度计和三轴陀螺仪软件包|
...
| [cw2015](https://github.com/qingehao/CW2015) |qingehao|Apache-2.0|锂电池电量计驱动|
...
| [realtek_ameba](https://github.com/RT-Thread-packages/realtek_ameba) |flyingcys|LGPL-2.1|realtek 的 ameba 软件包在 RT-Thread 上的移植|
| [pms_series](https://github.com/MrpYoung/pms_series) |MrpYoung|MIT|pms 数字式通用颗粒物浓度传感器驱动库|
| [io_input_filter](https://github.com/lizdDong/io_input_filter) |lizdDong|Apache-2.0|IO输入软件滤波模块|
| [rfm300](https://github.com/kylepengchn/rfm300.git) |kylepengchn|Apache-2.0|IO输入软件滤波模块|
| [i2c-tools](https://github.com/RT-Thread-packages/rt-i2c-tools) |wuhanstudio|MIT|I2C 调试时可以使用的小工具，可以扫描设备，读写寄存器|
| [fingerprint](https://github.com/pk-ing/fingerprint) |pk-ing|GPL-3.0|指纹模块驱动|
| [aip650](https://github.com/Maihuanyi/aip650) |Chasel| LGPL-2.1|一个快捷易用的数码管和按键驱动包适用于aip650和tm1650。|
| [wk2124](https://github.com/MrMichael/wk2124) |YaohongLi|Apache-2.0|wk2124 spi转四串口芯片的驱动库。|
| [bt_ecb02c](https://github.com/qiyongzhong0/rt-thread-bt_ecb02c) |qiyongzhong0| LGPL-2.1|蓝牙芯片ECB02C的设备驱动|
...
| [gc9a01](https://github.com/hywing/rtt-gc9a01) |hywing|Apache-2.0|基于gc9a01的圆形TFT LCD驱动，支持SPI|
| [lrf-nv7lidar](https://github.com/RT-Thread-packages/nv7lidar) |shenzan|LGPL-2.1|LRF-NV7激光测距模组|
...
| [ikun-485](https://github.com/sulfurandcu/ikun-485) |sulfurandcu|MIT|基于字符设备的 RS485 驱动|
| [ic74hc165](https://github.com/godmial/ic74hc165.git) |godmial|Apache-2.0|用于RT-Thread 的74HC165串行输入并行输出芯片驱动,支持GPIO与SPI两种模式|
...
| [libcrc](https://github.com/wangwang105/rtt-libcrc.git) |wangwang105|MIT|一个移植libcrc的crc校验计算函数库。|
...
| [TinySquare](https://github.com/AlgoOy/TinySquare) |AlgoOy|Apache-2.0|TinySquare：一个运行在Cortex-M上的轻量化方块游戏引擎。|
| [c2048](https://github.com/mysterywolf/c2048) |Meco Man|MIT|2048是一款益智类游戏，原版游戏运行在苹果手机上|
| [threes](https://github.com/mysterywolf/threes) |Meco Man|MIT|threes是一款在2014年很火的益智类游戏，原版游戏运行在苹果手机上|
| [donut](https://github.com/mysterywolf/donut) |Meco Man|None|使用字符渲染的3D旋转甜甜圈|
| [snake](https://github.com/mysterywolf/snake) |Meco Man|GPL-2.0|贪吃蛇游戏|
...
| [cal](https://github.com/mysterywolf/cal) |Meco Man|MIT|终端公历日历|
| [aclock](https://github.com/mysterywolf/aclock) |Meco Man|Apache-2.0|终端钟表界面|
| [morse](https://github.com/zhkag/morse) |zhkag|None|摩尔斯电码|
...
| [CorevMCU_CLI](https://github.com/Yaochenger/CorevMCU_CLI) |Yaochenger|LGPL-2.1|Core-V-MCU的CLI组件|
...
| [get_irq_priority](https://github.com/wdfk-prog/rt-thread-get_irq_priority) |hly|LGPL-2.1|获取Cortex®-M内核的中断优先级.|
| [ki](https://github.com/mysterywolf/ki) |Meco Man|GPL-2.0|ki是一个带有C/C++语法高亮的终端编辑器|
| [MultiButton](https://github.com/RT-Thread-packages/MultiButton) |0x1abin|MIT|一个小巧易用的事件驱动按钮驱动模块|
| [libcsv](https://github.com/liu2guang/libcsv) |liu2guang|LGPL-2.1|libcsv是用纯ANSI C89编写的小型、简单、快速的CSV库，支持读写CSV数据|
| [lzma](https://github.com/RiceChen0/lzma) |RiceChen|LGPL-2.1|高压缩率的压缩库|
...
| [optparse](https://github.com/RT-Thread-packages/optparse) |RT-Thread-packages|Unlicense|基于 RT-Thread 的 Getopt 命令行解析器|
...
| [ralarm](https://github.com/RiceChen0/ralarm) |RiceChen|Apache-2.0|ralarm: 不依赖硬件，可以无限扩展的闹钟组件|
| [lwgps](https://github.com/orange2348/lwgps2rtt) |orange2348|MIT|轻量级GPS NMEA协议解析器|
| [drmp](https://github.com/qiyongzhong0/rt-thread-drmp) |qiyongzhong0| LGPL-2.1|用于设备远程维护的协议栈|
...
| [wifi-host-driver](https://github.com/Evlers/rt-thread_wifi-host-driver) |Evlers|MIT|用于RT-Thread的WiFi主机驱动程序。|
...
| [lhc_modbus](https://github.com/LHC324/lhc_modbus) |LHC324|Apache-2.0|轻量级和高性能的C语言modbus协议栈。|
| [wayz_iotkit](https://github.com/wayz-iot/wayz_iotkit) |jianxiong.ye|GPL-2.0|wayz iot 定位软件包|
...
| [zephyr_polling](https://github.com/bobwenstudy/RTT_PACKAGE_zephyr_polling) |bobwenstudy|Apache-2.0|zephyr_polling: 蓝牙BLE协议栈。|
...
| [OpENer](https://github.com/EIPStackGroup/OpENer) |Martin Melik|BSD-3-Clause|用于 I/O 适配器设备的 EtherNet/IP 堆栈|
| [OpENer_port](https://github.com/loogg/OpENer_rtt_port) |loogg|BSD-3-Clause|RT-Thread 的 OpENer 移植|
| [nanopb](https://github.com/RT-Thread-packages/nanopb) |RealThread|Zlib|Protocol Buffers 解析器在嵌入式上的实现|
| [cyw43xx](https://github.com/RT-Thread-packages/CYW43xx) |Damien George|non-commercial use|CYW43xx WiFi/BT SoC 驱动|
| [net_server](https://github.com/WKJay/net-server) |WKJay|Apache-2.0|TCP/TLS 服务器，支持wolfssl。|
| [ipmsg](https://github.com/heyuanjie87/ipmsg) |heyuanjie87|Apache-2.0|在 RT-Thread 上实现的 飞鸽传书|
| [p-net-rtt](https://github.com/kurisaW/p-net-rtt) |Wangyuqiang|GPL-3.0|用于 Profinet 设备实现的 P-Net 开源协议栈|
...
| [RyanMqtt](https://github.com/Ryan-CW-Code/RyanMqtt) |Ryan-CW|Apache-2.0|RyanMqtt 实现了 MQTT3.1.1 协议的客户端。此库针对资源受限的嵌入式设备进行了优化。|
...
| [bt_cyw43012](https://github.com/Guozhanxin/cyw43012-ble-RTT) |RealThread|Apache-2.0|CYW43012 的 bt 驱动|
...
| [wlan_cyw43439](https://github.com/Z8MAN8/cyw43439-RTT) |Z8MAN8|Apache-2.0|CYW43439 的 wlan 驱动|
| [wlan_bl808](https://github.com/flyingcys/wlan_bl808_rtthread) |flyingcys|Apache-2.0|BL808 的 wlan 驱动|
| [rw007](https://github.com/RT-Thread-packages/rw007) |RealThread|Apache-2.0|RT-Thread 的 RW007 驱动（SPI Wi-Fi 模式）|
| [wlan_cyw43012](https://github.com/Guozhanxin/cyw43012-RTT) |RealThread|Apache-2.0|CYW43012 的 wlan 驱动|
...
| [kawaii-mqtt](https://github.com/jiejieTop/kawaii-mqtt) |jiejie|Apache-2.0|一个基于socket API之上的跨平台MQTT客户端，拥有非常简洁的API接口，以极少的资源实现QOS2的服务质量，并且无缝衔接了mbedtls加密库。|
...
| [RyanW5500](https://github.com/Ryan-CW-Code/RyanW5500) |Ryan-CW|Apache-2.0|W5500 BSD套接字实现。|
...
| [matter-adaptation-layer](https://github.com/kurisaW/MATTER-Adaptation_Layer) |kurisaW|Apache-2.0|CSA联盟指导的Matter协议栈在RT-Thread的移植|
| [qmodbus](https://github.com/qiyongzhong0/qmodbus) |qiyongzhong0| LGPL-2.1|一款快捷易用的modbus通信协议栈|
...
| [RyanJson](https://github.com/Ryan-CW-Code/RyanJson) |Ryan-CW|Apache-2.0|一个针对资源受限的嵌入式设备优化的c语言Json库,内存占用极小的通用Json库,简洁高效!|
