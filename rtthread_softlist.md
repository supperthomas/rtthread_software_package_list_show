...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/loogg/agile_telnet)| [agile_telnet](https://github.com/loogg/agile_telnet) |以太网TCP调试。|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Seeed-Studio/Grove_Barometer_Sensor)| [Seeed-BMP085](https://github.com/Seeed-Studio/Grove_Barometer_Sensor) |Seeed BMP085/BMP180 |
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Seeed-Studio/Grove_HighTemp_Sensor)| [Seeed-HighTemp](https://github.com/Seeed-Studio/Grove_HighTemp_Sensor) |Seeed HighTemp K型热电偶|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Seeed-Studio/Grove_Barometer_HP20x)| [Seeed-HP20x](https://github.com/Seeed-Studio/Grove_Barometer_HP20x) |Seeed HP20x 气压、高度计和温|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/adafruit/Adafruit_MS8607)| [Adafruit-MS8607](https://github.com/adafruit/Adafruit_MS8607) |Adafruit MS8607压力温湿度|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Seeed-Studio/Grove_3_Axis_Digital_Gyro)| [Seeed-ITG3200](https://github.com/Seeed-Studio/Grove_3_Axis_Digital_Gyro) |Seeed ITG3200 三轴数字陀螺|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/kendryte-k210-sdk)| [K210-SDK](https://github.com/RT-Thread-packages/kendryte-k210-sdk) |勘智 K210 处理器对应的外设驱动包|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Forest-Rain/multi-rtimer)| [multi_rtimer](https://github.com/Forest-Rain/multi-rtimer) |一个实时、低功耗软件定时器模块|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/nfsq246/RTT_BMP280)| [bmp280](https://github.com/nfsq246/RTT_BMP280) |bmp280的iic驱动|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/sogwms/nrf24l01)| [nrf24l01](https://github.com/sogwms/nrf24l01) |单芯片 2.4GHz 无线收发器。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/micro_ros)| [micro_ros](https://github.com/wuhanstudio/micro_ros) |在 MCU 上运行 ROS2.|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Maihuanyi/aip650)| [aip650](https://github.com/Maihuanyi/aip650) |一个快捷易用的数码管和按键驱动包适用于a|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/greedyhao/MotionDriver2RTT)| [MotionDriver2RTT](https://github.com/greedyhao/MotionDriver2RTT) |移植 MotionDriver 到 RT|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/liuduanfei/ft6236)| [ft6236](https://github.com/liuduanfei/ft6236) |这是 FT6236 触摸芯片的驱动包。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Jackistang/GT1151)| [gt1151](https://github.com/Jackistang/GT1151) |gt1151 驱动|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Z8MAN8/cst816x)| [cst816x](https://github.com/Z8MAN8/cst816x) |cst816x 触摸芯片的驱动包。|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/ft6206)| [ft6206](https://github.com/RT-Thread-packages/ft6206) |这是 FT6206 触摸芯片的驱动包。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/liuduanfei/ft5426)| [ft5426](https://github.com/liuduanfei/ft5426) |这是 FT5426 触摸芯片的驱动包。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RiceChen0/gt911)| [gt911](https://github.com/RiceChen0/gt911) |gt911 驱动。|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Ghazigq/nes)| [nes](https://github.com/Ghazigq/nes) |nes模拟器c库。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/luhuadong/rtt-ssd1306)| [ssd1306](https://github.com/luhuadong/rtt-ssd1306) |基于 SSD1306、SH1106、SH|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/redocCheng/max7219)| [max7219](https://github.com/redocCheng/max7219) |本软件包是在数码管上应用 MAX7219|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/rt-i2c-tools)| [i2c-tools](https://github.com/wuhanstudio/rt-i2c-tools) |I2C 调试时可以使用的小工具，可以扫描|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/loogg/agile_led)| [agile_led](https://github.com/loogg/agile_led) |一个灵活的led软件包。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/raspberrypi-pico-sdk)| [raspberrypi-pico-sdk](https://github.com/RT-Thread-packages/raspberrypi-pico-sdk) |Raspberry Pi Pico SD|
...
## tools
 ...
 |pull request| 包名 |  备注      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |  ------------------------------------------------------------ |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/anv_trace)| [anv_trace](https://github.com/wuhanstudio/anv_trace) |帮助跟踪代码执行过程|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/dhrystone)| [Dhrystone](https://github.com/wuhanstudio/dhrystone) |Dhrystone 单片机性能测试小工具|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/lxzzzzzxl/Chinese_font_library)| [ChineseFontLibrary](https://github.com/lxzzzzzxl/Chinese_font_library) |rt-thread中文字库软件包|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/armink-rtt-pkgs/ulog_easyflash)| [ulog_easyflash](https://github.com/armink-rtt-pkgs/ulog_easyflash) |基于 EasyFlash 的 ulog |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/illusionlee/lunar_calendar)| [lunar_calendar](https://github.com/illusionlee/lunar_calendar.git) |将阳历日期转换为阴历的工具。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/2022alpha/snowflake)| [snowflake](https://github.com/2022alpha/snowflake) |雪花算法是一种分布式ID生成算法。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/SummerLife/MemoryPerf)| [MemoryPerf](https://github.com/SummerLife/MemoryPerf) |ARM CPU 内存性能测试。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/anv_bench)| [anv_bench](https://github.com/wuhanstudio/anv_bench) |函数性能快速测试软件包|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/JcZou/uMCN)| [uMCN](https://github.com/JcZou/uMCN) |uMCN是一个基于发布者/订阅者模式的轻|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/illusionlee/bs8116a)| [bs8116a](https://github.com/illusionlee/bs8116a.git) |合泰的bs8116a-3的触摸按键芯片|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/enkiller/vconsole)| [vconsole](https://github.com/enkiller/vconsole) |一个虚拟控制台软件包。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/XYX12306/gan_zhi)| [gan_zhi](https://github.com/XYX12306/gan_zhi.git) |是一个根据公历日期、时得到相应的天干地支|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/kdb)| [kdb](https://github.com/RT-Thread-packages/kdb) |内核检测漏洞工具|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/jch12138/UrlEncode)| [UrlEncode](https://github.com/jch12138/UrlEncode.git) |一个简单易用的Url编解码工具|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/balanceTWK/armv7m_DWT)| [armv7m_DWT](https://github.com/balanceTWK/armv7m_DWT.git) |armv7m_DWT: 基于 ARMV7|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/armink-rtt-pkgs/CmBacktrace)| [CmBacktrace](https://github.com/armink-rtt-pkgs/CmBacktrace) |ARM Cortex-M 系列 MCU |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/bytecodealliance/wasm-micro-runtime)| [wamr](https://github.com/bytecodealliance/wasm-micro-runtime.git) |运行于RT-Thread的WebAsse|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/xfan1024/rttpkg-mbedtls_bench)| [mbedtls_bench](https://github.com/xfan1024/rttpkg-mbedtls_bench) |mbedtls 性能测试|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/SEGGER_SystemView)| [SystemView](https://github.com/RT-Thread-packages/SEGGER_SystemView) |SEGGER 的 SystemView |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/xiaogeminghai/vofa_plus)| [vofa_plus](https://github.com/xiaogeminghai/vofa_plus) |配合vfoa+实现串口波形功能|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/fdt)| [fdt](https://github.com/RT-Thread-packages/fdt) |RT-Thread 设备树工具包|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/luanxg/devmem)| [devmem](https://github.com/luanxg/devmem) |读写内存/寄存器的工具|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/anv_testsuit)| [anv_testsuit](https://github.com/wuhanstudio/anv_testsuit) |单元测试框架|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/lwlog)| [lwlog](https://github.com/wuhanstudio/lwlog) |lwlog:单文件日志打印库|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/XYX12306/solar_terms)| [solar_terms](https://github.com/XYX12306/solar_terms.git) |是一个根据公历日期判断与二十四节气关系的|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/enkiller/cbox)| [cBox](https://github.com/enkiller/cbox) |CBOX: C 语言小工具。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Jackistang/lwrb2rtt)| [lwrb2rtt](https://github.com/Jackistang/lwrb2rtt) |轻量级的 FIFO 环形缓冲区|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/coremark)| [CoreMark](https://github.com/wuhanstudio/coremark) |EEMBC 的单片机性能测试小工具|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/smartmx/hash-match)| [hash-match](https://github.com/smartmx/hash-match) |应用在单片机上快速匹配的哈希算法|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/ulog_file)| [ulog_file](https://github.com/RT-Thread-packages/ulog_file.git) |ulog_file: 基于文件系统的 u|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/enkiller/cpu_usage)| [cpu_usage](https://github.com/enkiller/cpu_usage) |CPUU: CPU 使用率统计小工具。|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/armink-rtt-pkgs/EasyLogger)| [EasyLogger](https://github.com/armink-rtt-pkgs/EasyLogger) |一款超轻量级(ROM<1.6K, RAM|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/maplerian/gps_rmc)| [gps_rmc](https://github.com/maplerian/gps_rmc) |用于解析GPS模块的 $XXRMC 类型|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/logmgr)| [logmgr](https://github.com/RT-Thread-packages/logmgr.git) |logmgr: 日志管理系统功能支持|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/anv_memleak)| [anv_memleak](https://github.com/wuhanstudio/anv_memleak) |检查是否存在内存泄漏|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Ghazigq/gbk2utf8)| [gbk2utf8](https://github.com/Ghazigq/gbk2utf8) |GBK与UTF8编码之间的转换。|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Ruboom/RT_Trace)| [RT_Trace](https://github.com/Ruboom/RT_Trace) |使用 J-Link 实现事件监控|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/armink-rtt-pkgs/EasyFlash)| [EasyFlash](https://github.com/armink-rtt-pkgs/EasyFlash) |轻量级嵌入式 Flash 存储器库，让 |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/supperthomas/RTT_AUTO_EXE_CMD)| [rtt_auto_exe_cmd](https://github.com/supperthomas/RTT_AUTO_EXE_CMD.git) |该软件包用来自动执行finsh的命令，主|

## security

 |pull request| 包名 |  备注      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |  ------------------------------------------------------------ |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/libsodium-legacy)| [libsodium](https://github.com/RT-Thread-packages/libsodium-legacy) |一个现代的、易用的加密库 (不推荐在 M|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/china-hai/yd_crypto)| [yd_crypto](https://github.com/china-hai/yd_crypto) |用于微控制器的加解密算法库，平台无关、算|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/tinycrypt)| [tinycrypt](https://github.com/RT-Thread-packages/tinycrypt) |一个简小并且可配置的加解密软件包|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/libhydrogen)| [libhydrogen](https://github.com/wuhanstudio/libhydrogen) |一个轻量级，易用，适合嵌入式的密码学软件|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/mbedtls)| [mbedtls](https://github.com/RT-Thread-packages/mbedtls) |一个开源的、可移植的、易于使用的、可读的|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/trusted-firmware-m)| [trusted-firmware-m](https://github.com/RT-Thread-packages/trusted-firmware-m) |Cortex M系列架构安全固件|

## system

 |pull request| 包名 |  备注      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |  ------------------------------------------------------------ |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/bigmagic123/openamp)| [openamp](https://github.com/bigmagic123/openamp.git) |RT-Thread OpenAMP软件包|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/partition)| [partition](https://github.com/RT-Thread-packages/partition) |一个基于块设备的分区管理软件包|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Aladdin-Wang/flash_blob)| [flash_blob](https://github.com/Aladdin-Wang/flash_blob.git) |用于快速生成flash驱动文件的工具和f|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/GorgonMeducer/perf_counter)| [perf_counter](https://github.com/GorgonMeducer/perf_counter) |Cortex-M systick 的专用|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/cairo)| [cairo](https://github.com/RT-Thread-packages/cairo) |适用于多平台的 2D 图形软件包|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/smartmx/TFDB)| [TFDB](https://github.com/smartmx/TFDB) |通用精简稳定的单片机flash存储数据方|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/armink/FlashDB)| [FlashDB](https://github.com/armink/FlashDB) |一款支持 KV 数据和时序数据的轻量级数|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/FreeRTOS-Wrapper)| [FreeRTOS_Wrapper](https://github.com/RT-Thread-packages/FreeRTOS-Wrapper) |RT-Thread操作系统的FreeRT|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/uC-Clk-for-RT-Thread)| [uC_CLK](https://github.com/mysterywolf/uC-Clk-for-RT-Thread) |uC/Clk for RT-Thread|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/uC-Modbus-for-RT-Thread)| [uC_Modbus](https://github.com/mysterywolf/uC-Modbus-for-RT-Thread) |uC/Modbus for RT-Thr|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/uC-CRC-for-RT-Thread)| [uC_CRC](https://github.com/mysterywolf/uC-CRC-for-RT-Thread) |uC/CRC for RT-Thread|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/uC-Common-for-RT-Thread)| [uC_Common](https://github.com/mysterywolf/uC-Common-for-RT-Thread) |uC/Common for RT-Thr|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/Zhyolo/qpc-rtthread)| [qpc](https://github.com/Zhyolo/qpc-rtthread) |轻量级软件框架 QP/C|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/plctlab/mlibc)| [mlibc](https://github.com/plctlab/mlibc) |mbedded libc, especi|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/event_recorder)| [event_recorder](https://github.com/RT-Thread-packages/event_recorder) |一款轻量级的事件记录器，支持事件的记录与|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/littlefs)| [littlefs](https://github.com/RT-Thread-packages/littlefs) |为微控制器设计的一个小型的且掉电安全的文|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/CMSIS_RTOS2)| [CMSIS_RTOS2](https://github.com/RT-Thread-packages/CMSIS_RTOS2) |RT-Thread的CMSIS-RTOS|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/CMSIS_5_AUX)| [CMSIS_5_AUX](https://github.com/RT-Thread-packages/CMSIS_5_AUX) |CMSIS_5软件包的辅助构建软件包（该|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/ARM-software/CMSIS_5)| [CMSIS_5](https://github.com/ARM-software/CMSIS_5) |CMSIS-5|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/CMSIS_RTOS1)| [CMSIS_RTOS1](https://github.com/RT-Thread-packages/CMSIS_RTOS1) |RT-Thread的CMSIS-RTOS|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/loogg/agile_upgrade)| [agile_upgrade](https://github.com/loogg/agile_upgrade) |用于快速构建 bootloader 的中|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/kylepengchn/kmulti_rtimer)| [kmulti_rtimer](https://github.com/kylepengchn/kmulti_rtimer.git) |用于快速构建 bootloader 的中|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/sakumisu/CherryUSB)| [CherryUSB](https://github.com/sakumisu/CherryUSB) |小而美、可移植性高的 USB 主从协议栈|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/rt_memcpy_cm)| [rt_memcpy_cm](https://github.com/mysterywolf/rt_memcpy_cm) |rt_memcpy函数的Cortex-M|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/rt_kprintf_threadsafe)| [rt_kprintf_threadsafe](https://github.com/mysterywolf/rt_kprintf_threadsafe) |线程安全版本的rt_kprintf|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/mysterywolf/rt_vsnprintf_full)| [rt_vsnprintf_full](https://github.com/mysterywolf/rt_vsnprintf_full) |rt_vsnprintf全功能版本|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/fal)| [fal](https://github.com/RT-Thread-packages/fal) |Flash 抽象层的实现，负责管理 Fl|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/sogwms/EV)| [EV](https://github.com/sogwms/EV) |高效开发 vehicles(包括无人机)|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/hichard/minIni)| [minIni](https://github.com/hichard/minIni) |minIni 在 RT-Thread 上|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/lvgl/lvgl)| [LVGL](https://github.com/lvgl/lvgl) |LVGL轻量级通用型图形库（官方上游）|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/lv_demo_music)| [lv_music_demo](https://github.com/RT-Thread-packages/lv_demo_music) |LVGL的播放器演示示例(RT-Thre|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/NXPmicro/gui-guider-demos)| [gui_guider_demo](https://github.com/NXPmicro/gui-guider-demos.git) |GUI Guider生成的LVGL演示示|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/myshowtogo/3gpp_amrnb)| [3gpp_amrnb](https://github.com/myshowtogo/3gpp_amrnb) |3gpp amrnb 编解码库|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages-by-SummerGift/openmv)| [openmv](https://github.com/RT-Thread-packages-by-SummerGift/openmv) |openmv 在 RT-Thread 上|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/RT-Thread-packages/gui_engine)| [gui_engine](https://github.com/RT-Thread-packages/gui_engine) |来自 RT-Thread 官方的 GUI|
...
## ai
 ...
 |pull request| 包名 |  备注      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |  ------------------------------------------------------------ |
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/naxos)| [naxos](https://github.com/wuhanstudio/naxos) |C++ Constraint Progr|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/yc66542260/ncnn-rtthread)| [ncnn](https://github.com/yc66542260/ncnn-rtthread) |ncnn静态库|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/rt-onnx-parser)| [onnx-parser](https://github.com/wuhanstudio/rt-onnx-parser) |开源神经网络模型 onnx 解析库|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/onnx-backend)| [onnx-backend](https://github.com/wuhanstudio/onnx-backend) |开源神经网络模型 onnx 后端，支持几|
|![GitHub pull requests](https://img.shields.io/github/issues-pr/majianjia/nnom)| [nnom](https://github.com/majianjia/nnom) |轻量级的神经网络框架, 模型一键转换, |
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/wuhanstudio/rt-libann)| [libann](https://github.com/wuhanstudio/rt-libann) |轻量级 ANN 库，可以训练，保存和导入|
...
|![GitHub pull requests](https://img.shields.io/github/issues-pr/LONGZR007/fire_pid_curve)| [fire_pid_curve](https://github.com/LONGZR007/fire_pid_curve.git) |野火PID调试助手通讯协议软件包|
